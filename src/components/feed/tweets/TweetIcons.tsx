...
const TweetIcons = ({ replyCount, retweetCount, likeCount, viewCount }: Props) => {
	return (
		<div className="flex justify-between mt-2 pl-10 max-w-lg">
			...
			<TweetIcon hoverBgColor="group-hover:bg-twitter/20" hoverTextColor="group-hover:text-twitter">
